...
resDir = "/data/projects/2024/duszka/NB_project/out/30_tpm_counts_130624"
...
colnames(annotation_data) <- paste0(comparison[2],"_vs_",comparison[1])
colname = as.character(paste0(comparison[1],"_vs_",comparison[2]))
...
ht = Heatmap(data_norm, name = "z-score", rect_gp = gpar(col = "white", lwd = 2),
    ...
    column_split =filtered_allSampleAnno$sample_type, 
     row_title_rot = 0, right_annotation = ha)


hz <- draw(ht, annotation_legend_list = list(lgd_pvalue, lgd_sig))
hz
